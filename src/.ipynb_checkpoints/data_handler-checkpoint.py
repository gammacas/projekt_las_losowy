...
def load_and_preprocess_data(url_train: str, url_test: str) -> tuple:
    print("[1/4] Pobieranie danych z repozytorium zdalnego...")
    ...
    print("[2/4] Preprocessing i kodowanie zmiennych kategorycznych...")
    ...
    print("[3/4] Standaryzacja zmiennych numerycznych...")
